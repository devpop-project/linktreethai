  ...
  const handleOrderSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        customer_line: orderForm.line_id ? orderForm.line_id.trim() : null,
        address: orderForm.address ? orderForm.address.trim() : null,
        shipping_address: orderForm.address ? orderForm.address.trim() : null,
        ...
        line_channel_access_token: pageData.line_channel_access_token || null,
        line_user_id: pageData.line_user_id || null,
        line_notify_token: pageData.line_notify_token || null,
