            ...
            <div className="space-y-4">
              ...
              >
                {aiAnalyzing ? (
                  ...
                  {/* BEAUTIFUL SUCCESS MODAL ON SAVE */}
      {saveSuccessModalData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-md p-4 animate-in fade-in">
          <div className="w-full max-w-md bg-white dark:bg-[#131B2A] rounded-3xl p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5 animate-in zoom-in-95 text-center">
            ...
            <div className="w-16 h-16 mx-auto rounded-3xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-500 flex items-center justify-center shadow-lg shadow-emerald-500/20">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-400">
                เซลเพจของคุณพร้อมใช้งานออนไลน์เรียบร้อยแล้ว
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-2.5 text-left text-xs">
              <div className="flex items-center justify-between">
                <span className="text-slate-500 dark:text-slate-400 font-bold">หักค่าบริการ:</span>
                <span className="font-mono font-black text-amber-500">990 แต้ม (แต้มคงเหลือ: {saveSuccessModalData.remainingPoints.toLocaleString()} แต้ม)</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-slate-500 dark:text-slate-400 font-bold">โควตาเซลเพจ:</span>
                <span className="font-mono font-black text-purple-600 dark:text-purple-400">+1 ช่อง (โควตารวม: {saveSuccessModalData.totalSlots} ช่อง)</span>
              </div>
              <div className="flex items-center justify-between pt-2 border-t border-slate-200 dark:border-slate-800">
                <span className="text-slate-500 dark:text-slate-400 font-bold">ลิงก์หน้าจริง:</span>
                <span className="font-mono font-bold text-emerald-600 dark:text-emerald-400 truncate max-w-[200px]">/c/{saveSuccessModalData.slug}</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 pt-1">
              <button
                ...
                className="flex-1 py-3 rounded-2xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold text-xs transition cursor-pointer"
              >
                ปิด
              </button>
              <a
            ...
            {/* CELEBRATORY IN-APP SUCCESS MODAL: PUBLISH COMPLETED */}
      {saveSuccessData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-md p-4 animate-in fade-in">
          <div className="w-full max-w-md bg-white dark:bg-[#131B2A] rounded-3xl p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5 animate-in zoom-in-95 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-400 font-light">
                เซลเพจของคุณออนไลน์พร้อมสำหรับเปิดรับออเดอร์แล้ว
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-2.5 text-left text-xs">
              <div className="flex items-center justify-between">
                <span className="text-slate-500 dark:text-slate-400 font-medium">🪙 แต้มที่หัก:</span>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono font-bold text-emerald-600 dark:text-emerald-400">
                  {saveSuccessData.remaining.toLocaleString()} แต้ม
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-slate-500 dark:text-slate-400 font-medium">📦 โควตาเซลเพจ:</span>
                <span className="font-mono font-bold text-purple-600 dark:text-purple-400">
                  +1 ช่อง (โควตารวม {saveSuccessData.totalSlots} ช่อง)
                </span>
              </div>
              <div className="pt-2 border-t border-slate-200/60 dark:border-slate-800 flex items-center justify-between">
                <span className="text-slate-500 dark:text-slate-400 font-medium">🔗 ลิงก์หน้าจริง:</span>
                <span className="font-mono font-bold text-purple-600 dark:text-purple-400 truncate max-w-[200px]">
                  /c/{saveSuccessData.slug}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 pt-1">
              <a
                ...
                rel="noreferrer"
                style={{ backgroundColor: globalThemeColor }}
                className="flex-1 py-3 rounded-2xl text-white font-black text-xs shadow-lg shadow-purple-500/20 hover:opacity-90 active:scale-95 transition cursor-pointer flex items-center justify-center gap-1.5"
              >
                <span>เปิดดูหน้าจริง</span>
                <ExternalLink className="w-3.5 h-3.5" />
              </a>
              <button
                ...
                className="px-5 py-3 rounded-2xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold text-xs active:scale-95 transition cursor-pointer"
              >
                ตกลง / ปิด
              </button>
            </div>
            ...
            {/* BEAUTIFUL SUCCESS MODAL: SALEPAGE SAVED & PUBLISHED */}
      {isSaveSuccessModalOpen && successSavedData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-md p-4 animate-in fade-in">
          <div className="w-full max-w-md bg-white dark:bg-[#131B2A] rounded-3xl p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5 animate-in zoom-in-95 text-center">
            
            {/* Success Icon */}
            <div className="w-16 h-16 mx-auto rounded-3xl bg-gradient-to-br from-emerald-400 to-emerald-600 text-white flex items-center justify-center shadow-xl shadow-emerald-500/25">
            ...
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-left space-y-2.5">
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-500 dark:text-slate-400 font-medium">⚡ หักแต้ม:</span>
                <span className="font-mono font-bold text-amber-600 dark:text-amber-400">-990 แต้ม</span>
              </div>
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-500 dark:text-slate-400 font-medium">💰 แต้มคงเหลือ:</span>
                <span className="font-mono font-bold text-emerald-600 dark:text-emerald-400">{successSavedData.points.toLocaleString()} แต้ม</span>
              </div>
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-500 dark:text-slate-400 font-medium">📦 โควตาเซลเพจ:</span>
                <span className="font-mono font-bold text-purple-600 dark:text-purple-400">+1 ช่อง (รวม {successSavedData.slots} ช่อง)</span>
              </div>
              <div className="pt-2 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs">
                <span className="text-slate-500 dark:text-slate-400 font-medium">🔗 ลิงก์หน้าจริง:</span>
                <span className="font-mono font-bold text-purple-600 dark:text-purple-400 truncate max-w-[180px]">/c/{successSavedData.slug}</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2.5 pt-1">
              <a
                href={`/c/${successSavedData.slug}`}
                target="_blank"
                rel="noreferrer"
                style={{ backgroundColor: globalThemeColor }}
                className="w-full sm:flex-1 py-3 rounded-2xl text-white font-black text-xs shadow-xl hover:opacity-90 active:scale-95 transition cursor-pointer flex items-center justify-center gap-1.5"
              >
                <span>เปิดดูหน้าจริง</span>
                <ExternalLink className="w-3.5 h-3.5" />
              </a>
              <button
                ...
                className="w-full sm:w-auto px-5 py-3 rounded-2xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold text-xs transition cursor-pointer"
              >
                ปิด
              </button>
            </div>
      ...
      {isConfirmSaveModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-md p-4 animate-in fade-in">
          <div className="w-full max-w-md bg-white dark:bg-[#131B2A] rounded-3xl p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5 animate-in zoom-in-95">
            ...
            {/* BEAUTIFUL SUCCESS MODAL: PUBLISHED & POINTS DEDUCTED */}
      {saveSuccessData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-md p-4 animate-in fade-in">
          <div className="w-full max-w-md bg-white dark:bg-[#131B2A] rounded-3xl p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5 animate-in zoom-in-95">
            ...
            <div className="text-center space-y-2">
              <div className="w-14 h-14 mx-auto rounded-3xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-500 flex items-center justify-center shadow-lg shadow-emerald-500/20 animate-bounce">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 font-light">
                ระบบได้บันทึกโครงสร้าง 13 บล็อก และเผยแพร่หน้าเว็บเรียบร้อยแล้ว
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-2.5">
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-500 dark:text-slate-400 font-bold">🪙 หักแต้มค่าบริการ:</span>
                <span className="font-mono font-black text-amber-600 dark:text-amber-400">-{saveSuccessData.deducted.toLocaleString()} แต้ม</span>
              </div>
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-500 dark:text-slate-400 font-bold">💰 แต้มคงเหลือ:</span>
              ...
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-500 dark:text-slate-400 font-bold">📦 โควตาเซลเพจที่ได้รับ:</span>
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <a
                ...
                rel="noreferrer"
                style={{ backgroundColor: globalThemeColor }}
                className="flex-1 py-3 rounded-2xl text-white font-black text-xs shadow-xl shadow-purple-500/25 hover:opacity-90 active:scale-95 transition cursor-pointer text-center flex items-center justify-center gap-1.5"
              >
                <span>เปิดดูหน้าจริง ↗</span>
              </a>
            </div>
