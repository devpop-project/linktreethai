              ...
              >
                <div className="flex items-center gap-3.5 overflow-hidden pr-2">
                  {link.logo_url ? (
                    ...
                    <div style={{ backgroundColor: link.icon_bg_color || undefined }} className="w-10 h-10 bg-cyan-500/20 text-cyan-300 rounded-2xl flex items-center justify-center shrink-0 border border-cyan-400/30">
